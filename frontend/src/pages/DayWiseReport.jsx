                     ...
                     <div className="col-md-12">
                         <div style={{ padding: "20px" }}
                             ...
                             <div className="flex justify-center items-center">
                                 <div style={{ marginTop: "0px",borderBottom:"none" }} className=" inn-title  ">
         ...
         <div className="flex justify-between items-center ">
             ...
             />
                                ...
                                <div className="border-b border-black-300"></div>
                                  <div className="flex justify-center align-center mt-2">
                                 <h3 className="text-2xl  font-bold mb-2"
                                 style={{color:"purple"}}>Total New Sales</h3>
                             </div>
                              {salesNewSalesPurchasesEachDay && newSales?.length>0 ?
                              newSales?.map((newSales,index) => (
                                <>
                                 <div className="w-8 h-8 rounded-full mt-1
                              ...
                              <div style={{padding:"0"}} className="tab-inn"
                              key={newSales?.sale_id}>
                                 <div style={{background: "#f0f0f0"}} className="row">
                                     <div className="input-field col s6">
                                         <span className="active">
                                             Party
                                         </span>
                                         <input type="text" value={newSales?.Party_Name ?? ""}
                                             className="validate" readOnly />
                                     ...
                                     <div className="input-field col s6">
                                         ...
                                         <input type="text" value={newSales?.Invoice_Number??""}
                                             className="validate" readOnly />
                                     ...
                                     <div className="input-field col s6">
                                         ...
                                         <input type="text"
                                             value={new Date(newSales?.Invoice_Date??"").toLocaleDateString({
                                                 day: "numeric",
                                                 month: "numeric",
                                                 year: "numeric",
                                             })}
                                     ...
                                     <div className="input-field col s6">
                                         ...
                                         <input type="text" value={newSales?.State_Of_Supply??""}
                                             className="validate" readOnly />
                                     ...
                                     <div className="input-field col s6">
                                         <span className="active">Payment Type</span>
                                         <input type="text" value={newSales?.Payment_Type??""}
                                             className="validate" readOnly />
                                     ...
                                     <div className="input-field col s6">
                                         ...
                                         <input type="text" value={newSales?.Reference_Number ?? "N/A"}
                                             className="validate" readOnly />
                                     </div>
                                 </div>
                                 <div className="table-responsive table-desi mt-4">
     ...
     style={{width:"100%"}}>
         ...
         <div className="flex justify-between items-center">
             ...
             <input
                 ...
                 type="text"
                 className="input-field border-b border-gray-300  w-1/2 p-1"
                 value={newSales?.Total_Amount ?? 0.00}
                 readOnly
             />
         </div>
         ...
         <div className="flex justify-between items-center">
             ...
             <input
                 ...
                 type="text"
                 className="input-field border-b border-gray-300 w-1/2 p-1"
                 value={newSales?.Total_Received ?? 0.00}
                 readOnly
             />
         </div>
         ...
         <div className="flex justify-between items-center ">
             ...
             <input
                 ...
                 type="text"
                 className="input-field  w-1/2 p-1 font-extrabold text-lg"
                 value={newSales?.Balance_Due ?? 0.00}
                 readOnly
             />
         </div>
                             ...
                             <p className="text-center">No new sales  </p>)}
                         {salesNewSalesPurchasesEachDay && newSales?.length>0 &&
                                <div className="grid grid-rows-2 mt-1">
         <div className=" flex justify-center items-center">
            <h4 >New Sales Summary</h4>
         </div> 
    <div className="grid grid-cols-3 gap-4  sm:w-1/2 md:w-1/3 "
     style={{width:"100%"}}>
         ...
         <div className="flex justify-between items-center">
             ...
             <input
                 ...
                 type="text"
                 className="input-field border-b border-gray-300   p-1"
                 value={salesNewSalesPurchasesEachDay?.newSales?.totalNewSalesAmount ?? 0.00}
                 readOnly
             />
         </div>
         ...
         <div className="flex justify-between items-center">
             ...
             <input
                 ...
                 type="text"
                 className="input-field border-b border-gray-300  p-1"
                 value={salesNewSalesPurchasesEachDay?.newSales?.totalNewSalesReceivedAmount ?? 0.00}
                 readOnly
             />
         </div>
         ...
         <div className="flex justify-between items-center ">
             ...
             <input
                 ...
                 type="text"
                 className="input-field   p-1 font-extrabold text-lg"
                 value={salesNewSalesPurchasesEachDay?.newSales?.totalNewSalesBalanceDue ?? 0.00}
                 readOnly
             />

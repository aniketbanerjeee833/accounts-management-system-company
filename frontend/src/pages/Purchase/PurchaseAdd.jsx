...
//       tax_amount: "0.00",
//       amount: "0.00",
//       // optional: separate itemSearch & itemOpen per row
//       itemSearch: "",
//       itemOpen: false,
//     },
//   ]);
...
// const handleAddRow = () => {
//   // add UI state
//   setRows((prev) => [...prev, { itemSearch: "", itemOpen: false,CategoryOpen:false ,isExistingItem: false }]);
...
// const handleAddRow = () => {
//   setRows((prev) => [
//     // close all previous dropdowns
//     ...prev.map((row) => ({ ...row, CategoryOpen: false , isHSNLocked: false, 
//       isUnitLocked: false, isExistingItem: false, categorySearch:""})), 
//     { itemSearch: "", itemOpen: false, CategoryOpen: false, isHSNLocked: false, 
//       isUnitLocked: false, isExistingItem: false, categorySearch: "" },
//   ]);
...
//   // Discount
//   let discount = parseFloat(row.Discount_On_Purchase_Price || 0);
//   if (row.Discount_Type_On_Purchase_Price === "Percentage") {
...
//   // Tax
//   // let taxPercent = 0;
//   // if (row.Tax_Type && (row.Tax_Type.startsWith("GST") || row.Tax_Type.startsWith("IGST"))) {
//   //   taxPercent = parseFloat(row.Tax_Type.replace(/[^\d.]/g, "")) || 0; // works for 0.25, 5, 12, etc.
//   // }
...
//   // tax
//   const taxPercent = TAX_RATES[row.Tax_Type] ?? 0; // e.g. GST5 -> 5
//   const taxAmount = (afterDiscount * taxPercent) / 100;

//   // NOTE: if you use "With Tax" price, and want to back-calc base:
//   // if (row.Purchase_Price_Type === "With Tax" && taxPercent > 0) {
//   //   const base = afterDiscount / (1 + taxPercent / 100);
//   //   const tax = afterDiscount - base;
//   //   return { Tax_Amount: tax.toFixed(2), Amount: afterDiscount.toFixed(2) };
//   // }
...
//   });
//   console.log(totalAmount,"totalAmount",finalAmount,"finalAmount",taxAmount,"taxAmount");
//   return {
//     ...row,
//     Quantity: String(qty),
//     Tax_Amount: taxAmount.toFixed(2),
                            ...
                            className="box-inn-sp">
                              <div className="inn-title">
                                ...
                                <div >
                                        ...
                                        <h4 className="text-2xl font-bold mb-2">Add New Purchase</h4>
 ...
 <div className="flex justify-end gap-4 mt-4">
   <button
                  ...
                  <button
                    ...
                    style={{ backgroundColor: "#4CA1AF" }}
                  >
                    {isAddingPurchase ? "Adding Purchase..." : "Add Purchase"}
                  </button>
                </div>
                                </form>

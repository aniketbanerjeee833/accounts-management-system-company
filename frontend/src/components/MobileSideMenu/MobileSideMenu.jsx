...
//     return true;
//   }
//    if((linkTo === `/sale/add/`) || (linkTo === `/sale/invoice/`)){
//     return true;
//   }
//     if(linkTo === `/sale/all-sales/`){
//     return true;
//   }
